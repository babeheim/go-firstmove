...
if (have_raw_data) {
  ...
  # eliminate <- c("./temp/Kogo's Joseki Dictionary_May2006.sgf", 
  #   "./temp/MonsterGo1.sgf")
  # file.remove(eliminate)

  gogod <- game.table.maker('./temp/Go CD/Database')

  stopifnot(nrow(gogod) == 60350)

  write.csv(gogod, "./raw_data/gogod_database.csv", row.names = FALSE)
...
drop <- grep("1253-02-00a.sgf", d$filename)
drop <- c(drop, grep("1561-00-00a.sgf", d$filename))
drop <- c(drop, grep("1566-00-00a.sgf", d$filename))
drop <- c(drop, grep("1620-00-00bf.sgf", d$filename))
drop <- c(drop, grep("1740hcem253.sgf", d$filename))
drop <- c(drop, grep("1740hcem295.sgf", d$filename))
drop <- c(drop, grep("1813-03-05a.sgf", d$filename))
drop <- c(drop, grep("1850-06-04OLD.sgf", d$filename))
drop <- c(drop, grep("1931-03-04u.sgf", d$filename))
drop <- c(drop, grep("1988-05-17e.sgf", d$filename))
drop <- c(drop, grep("1995-03-12g.sgf", d$filename))
drop <- c(drop, grep("1997-03-13d.sgf", d$filename))
drop <- c(drop, grep("2004-10-07fVR.sgf", d$filename))
