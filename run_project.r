...
file.copy("./1_clean_data/output/games.csv", "./2_explore_data/inputs")
...
file.copy("./1_clean_data/output/games.csv", "./3_build_dataframe/inputs")
...
file.copy("./3_build_dataframe/output/first_moves.csv", "./4_fit_models/inputs")
setwd("./4_fit_models")
source("./fit_models.r")
setwd("..")
toc(log = TRUE)
